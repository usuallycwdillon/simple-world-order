...
'''
usuallycwdillon: I'm using this as an exemplar for manipulating hex grids. I'll make each hex an object, tho so that
it can be a little more mutable and hold other mutable objects.
'''
